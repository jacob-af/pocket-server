...
export abstract class IQuery {
  ...
  abstract ingredients():
    | Nullable<Ingredient>[]
    | Promise<Nullable<Ingredient>[]>;

  abstract ingredient(
    id: number,
  ): Nullable<Ingredient> | Promise<Nullable<Ingredient>>;
...
export abstract class IMutation {
  ...
  abstract createManyIngredient(
    createIngredientInputs: Nullable<CreateIngredientInput>[],
  ): StatusMessage | Promise<StatusMessage>;

  abstract updateIngredient(
    updateIngredientInput: UpdateIngredientInput,
  ): Ingredient | Promise<Ingredient>;

  abstract removeIngredient(
    id: string,
  ): Nullable<Ingredient> | Promise<Nullable<Ingredient>>;
